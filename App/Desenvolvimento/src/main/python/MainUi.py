...
"}")
        ...
        self.frame_7.setMinimumSize(QtCore.QSize(0, 90))
        self.frame_7.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_7.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_7.setObjectName("frame_7")
        self.lcd_atvtempo = QtWidgets.QLCDNumber(self.frame_7)
        self.lcd_atvtempo.setGeometry(QtCore.QRect(20, 40, 121, 41))
        self.lcd_atvtempo.setContextMenuPolicy(QtCore.Qt.NoContextMenu)
        self.lcd_atvtempo.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.lcd_atvtempo.setMidLineWidth(0)
        self.lcd_atvtempo.setSmallDecimalPoint(False)
        self.lcd_atvtempo.setSegmentStyle(QtWidgets.QLCDNumber.Filled)
        self.lcd_atvtempo.setProperty("value", 0.0)
        self.lcd_atvtempo.setProperty("intValue", 0)
        self.lcd_atvtempo.setObjectName("lcd_atvtempo")
        self.btn_voltar_tela_inicial = QtWidgets.QPushButton(self.frame_7)
        self.btn_voltar_tela_inicial.setGeometry(QtCore.QRect(800, 10, 161, 31))
        self.btn_voltar_tela_inicial.setObjectName("btn_voltar_tela_inicial")
        self.btn_pular = QtWidgets.QPushButton(self.frame_7)
        self.btn_pular.setGeometry(QtCore.QRect(800, 50, 161, 31))
        self.btn_pular.setObjectName("btn_pular")
        self.L_nome_aluno_logado = QtWidgets.QLabel(self.frame_7)
        self.L_nome_aluno_logado.setGeometry(QtCore.QRect(20, 10, 121, 21))
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_voltar_tela_inicial.setText(_translate("MainWindow", "Sair"))
