...
"}")
        ...
        self.btn_tela_editar_aluno = QtWidgets.QPushButton(self.tela_escolher_atividades)
        ...
        self.btn_tela_atividade_clique_na_imagem = QtWidgets.QPushButton(self.tela_escolher_atividades)
        self.btn_tela_atividade_clique_na_imagem.setObjectName("btn_tela_atividade_clique_na_imagem")
        self.horizontalLayout_3.addWidget(self.btn_tela_atividade_clique_na_imagem)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lnome_aluno_logado.setText(_translate("MainWindow", "TextLabel"))
        ...
        self.btn_tela_editar_aluno.setText(_translate("MainWindow", "Editar ou excluir aluno"))
