...
"}")
        ...
        self.Logo.setGeometry(QtCore.QRect(20, 40, 300, 101))
        self.Logo.setStyleSheet("background-image: url(:/tela/app_imagens/imagem logo falso.png);\n"
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lcampos.setText(_translate("MainWindow", "Verifica se senha e emails são iguais."))
