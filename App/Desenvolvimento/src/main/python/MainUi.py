...
"}")
        ...
        self.btn_tela_atividade_aletra_falta = QtWidgets.QPushButton(self.frame_9)
        self.btn_tela_atividade_aletra_falta.setObjectName("btn_tela_atividade_aletra_falta")
        self.verticalLayout.addWidget(self.btn_tela_atividade_aletra_falta)
        ...
        self.spinBox_2 = QtWidgets.QSpinBox(self.frame_9)
        ...
        self.tela_atividade_falta_a_letra = QtWidgets.QWidget()
        self.tela_atividade_falta_a_letra.setObjectName("tela_atividade_falta_a_letra")
        self.horizontalLayout_12 = QtWidgets.QHBoxLayout(self.tela_atividade_falta_a_letra)
        self.horizontalLayout_12.setObjectName("horizontalLayout_12")
        self.organizador = QtWidgets.QFrame(self.tela_atividade_falta_a_letra)
        ...
        self.organizador_meio.setStyleSheet("background-color: rgb(170, 170, 255);")
        ...
        self.stackedWidget.addWidget(self.tela_atividade_falta_a_letra)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_tela_atividade_clique_na_imagem.setText(_translate("MainWindow", "PushButton"))
        self.btn_tela_atividade_digt_nome_imagem.setText(_translate("MainWindow", "PushButton"))
        self.btn_tela_atividade_aletra_falta.setText(_translate("MainWindow", "PushButton"))
        ...
        self.label_5.setText(_translate("MainWindow", "Quantidade De Exercicios"))
